---
description: "Web design guidelines: visual identity, typography, color systems, motion, spatial composition, design system defaults"
...
- For accessibility and contrast requirements, see `.claude/rules/design/accessibility.md`.
- For UI structural patterns (layout, states, forms, modals), see `.claude/rules/design/ui-patterns.md`.
- For Tailwind utility usage and theming, see `.claude/rules/frontend/tailwind.md`.
- For React component patterns and quality checklist, see `.claude/rules/frontend/react-best-practices.md`.
