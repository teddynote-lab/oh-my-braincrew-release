---
name: lc-langchain-middleware
description: >
  (omb) Use when implementing HumanInTheLoopMiddleware, creating custom middleware hooks, resuming interrupted agents with Command, or configuring per-tool HITL policies.
