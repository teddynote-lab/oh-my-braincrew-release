---
name: lc-langchain-rag
description: >
  (omb) Use when building RAG pipelines: document loading, text splitting, embedding, vector store setup (Chroma, FAISS, Pinecone), or retrieval configuration.
