---
name: lc-langgraph-persistence
description: >
  (omb) Use when configuring LangGraph checkpointing (InMemorySaver, PostgresSaver), thread management, time travel, Store for cross-thread memory, or subgraph persistence scoping.
