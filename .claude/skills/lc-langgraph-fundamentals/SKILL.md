---
name: lc-langgraph-fundamentals
description: >
  (omb) Use when writing LangGraph code: StateGraph construction, state schemas with TypedDict and reducers, node functions, edges, Command routing, Send fan-out, or streaming execution.
