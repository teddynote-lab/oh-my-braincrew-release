---
name: lc-deep-agents-core
description: >
  (omb) Use when building Deep Agents applications with create_deep_agent(), configuring middleware (TodoList, Filesystem, SubAgent), or writing SKILL.md files for agent skills.
