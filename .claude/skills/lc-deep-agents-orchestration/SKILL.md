---
name: lc-deep-agents-orchestration
description: >
  (omb) Use when implementing Deep Agents subagent delegation (SubAgentMiddleware), task planning (TodoListMiddleware), or human-in-the-loop approval workflows.
