---
name: lc-deep-agents-memory
description: >
  (omb) Use when configuring Deep Agents storage backends (StateBackend, StoreBackend, FilesystemBackend, CompositeBackend) or cross-session memory.
