---
name: lc-langchain-deps
description: >
  (omb) Use when setting up package dependencies, checking version constraints, or configuring environment variables for LangChain, LangGraph, LangSmith, or Deep Agents projects.
