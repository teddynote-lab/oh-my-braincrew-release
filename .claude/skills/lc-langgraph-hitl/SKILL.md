---
name: lc-langgraph-hitl
description: >
  (omb) Use when implementing interrupt()/Command(resume) patterns in LangGraph, approval workflows, validation loops, or idempotent side effects before interrupt.
