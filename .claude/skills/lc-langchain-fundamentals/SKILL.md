---
name: lc-langchain-fundamentals
description: >
  (omb) Use when creating LangChain agents with create_agent(), defining tools with @tool decorator, configuring middleware, or implementing structured output with Pydantic/Zod.
