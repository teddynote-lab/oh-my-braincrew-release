---
name: lc-framework-selection
description: >
  (omb) Use when starting a LangChain/LangGraph/Deep Agents project, deciding which framework layer to use, or evaluating whether to mix layers.
